...
export default function Patients() {
  return (
    <div className="my-6 ">
      ...
      <Link to="/dashboard">
      <div className="grid grid-cols-12 bg-[#f0f0f0]  h-24 my-4 rounded-lg border-l-4 border-rose-600">
        <div className="col-span-2 flex justify-evenly items-center"> 
          <img className="w-20" src={Imgp2} />
        </div>
        <div className="col-span-6 text-start p-2"> 
             ...
             <p className="text-[10px] text-[#4c4c4c]">Start date : 15 February 2023</p>
        </div>
        <div className="col-span-4 flex justify-evenly items-center"> 
        <h1 className="rotate-[-90deg] text-[10px]">FA125MN</h1>
          <img className="w-6 mr-4" src={bar} />
      ...
      <Link to="/dashboard">
      <div className="grid grid-cols-12 bg-[#f0f0f0]  h-24 my-4 rounded-lg border-l-4 border-yellow-300">
        <div className="col-span-2 flex justify-evenly items-center"> 
        ...
        <div className="col-span-6 text-start p-2"> 
             ...
             <p className="text-[10px] text-[#707070] mt-3">56 Male</p>
             <p className="text-[10px] text-[#4c4c4c]">Start date : 30 July 2023</p>
        </div>
        <div className="col-span-4 flex justify-evenly items-center"> 
        <h1 className="rotate-[-90deg] text-[10px]">FA125MN</h1>
          <img className="w-6 mr-4" src={bar} />
      ...
      <div className="grid grid-cols-12 bg-[#f0f0f0]  h-24 my-4 rounded-lg border-l-4 border-yellow-300">
        ...
        <div className="col-span-6 text-start p-2"> 
             ...
             <p className="text-[10px] text-[#707070] mt-3">56 Male</p>
             <p className="text-[10px] text-[#4c4c4c]">Start date : 26 June 2023</p>
        </div>
        <div className="col-span-4 flex justify-evenly items-center"> 
        <h1 className="rotate-[-90deg] text-[10px]">FA125MN</h1>
          <img className="w-6 mr-4" src={bar} />
      ...
      <Link to="/dashboard">
      <div className="grid grid-cols-12 bg-[#f0f0f0]  h-24 my-4 rounded-lg border-l-4 border-green-500">
        <div className="col-span-2 flex justify-evenly items-center"> 
        ...
        <div className="col-span-6 text-start p-2"> 
             ...
             <p className="text-[10px] text-[#707070] mt-3">56 Male</p>
             <p className="text-[10px] text-[#4c4c4c]">Start date : 30 December 2023</p>
        </div>
        <div className="col-span-4 flex justify-evenly items-center"> 
        <h1 className="rotate-[-90deg] text-[10px]">FA125MN</h1>
          <img className="w-6 mr-4" src={bar} />
